...
- We know more than people often think!
...
- We want to help our sampler by constraining the parameter space smaller!
...
>2. inconclusive (i.e. $p>0.05$); try again
...
- Nested models: $H_0$ is nested in $H_1$ because in $H_0$ parameter of interest is fixed ($\beta=0$) but is free to vary in $H_1$ ($\beta\neq0$); $H_0$ can be obtained from $H_1$ by fixing parameter of interest.
</div>
